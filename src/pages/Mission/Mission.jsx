        ...
        <div className={styles.mission__container}>
            ...
            <div className={styles.content__row}>
                ...
                <div className={styles.content__column}>
                    <h2>Our Mission</h2>
                    <p>While we certainly work with teams to market and develop their NFT projects, our real mission is to <span style={stylesInner.bold}>accelerate the maturity of the ecosystem</span> <br/></p>
